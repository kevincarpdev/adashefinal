...
/// @title ADASHE token sale contract
/// @notice ETH (WETH) and USDC can be deposited in this contract to get ADSE tokens once the sale ends. The rate depends on the dollar value of the tokens raised
